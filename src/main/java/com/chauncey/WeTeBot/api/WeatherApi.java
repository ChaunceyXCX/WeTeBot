...
public class WeatherApi {
    ...
    private String key;
    @Value("${api.weather.type.now}")
    private String weatherTypeNow;
    @Value("${api.weather.type.forecast}")
    private String weatherTypeForecast;
    //@Value("${api.weather.type.hourly}")
    //private String weatherTypeHourly;
    @Value("${api.weather.type.lifestyle}")
    private String weatherTypeLifestyle;
    @Value("${api.weather.location.default}")
    ...
    HeWeather6 weatherAPI(String weatherType, String params) {
        String url = String.format(weatherUrl, weatherType, getParam(params), key);
